...
public class FieldAddTest extends Base {
	
	public static Logger log =LogManager.getLogger(FieldAddTest.class.getName());
	@BeforeTest
	public void FieldAdd() throws IOException
	{
	...
	public void FieldsAddTest(String f_type, int j) throws InterruptedException  
	{
