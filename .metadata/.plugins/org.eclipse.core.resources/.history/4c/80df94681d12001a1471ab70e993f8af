...
public class File_upload_RelatedFilesTest extends Base {
	public static Logger log =LogManager.getLogger(File_upload_RelatedFilesTest.class.getName());
	@BeforeTest
	...
	@Test
	public void RelatedFiles() throws IOException, InterruptedException
	{
