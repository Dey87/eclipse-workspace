...
public class Project_ManageUser_Page {
...
public WebDriver driver;
	...
	private By Cancel=By.xpath("//*[@id='ProjectManageUser']/div[2]/div/ul/li/input[1]");
	private By Save=By.xpath("//*[@id='ProjectManageUser']/div[2]/div/ul/li/input[2]");
	
	
	public Project_ManageUser_Page(WebDriver driver) {
