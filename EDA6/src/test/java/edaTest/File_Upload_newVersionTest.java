...
public class File_Upload_newVersionTest extends Base {
	public static Logger log =LogManager.getLogger(File_Upload_newVersionTest.class.getName());
	@BeforeTest
	...
	@Test
	public void File_Upload_newVersion() throws IOException, InterruptedException
	{
		...
		actions.contextClick(fp.getfileList()).perform();
		
		fp.getUploadNewVersion().click();
		Thread.sleep(2000);
