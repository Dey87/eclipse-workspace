...
public class ViewEditTest extends Base {
	
	public static Logger log =LogManager.getLogger(ViewEditTest.class.getName());
	@BeforeTest
	...
	@Test
	public void ViewEdit() throws IOException, InterruptedException
	{
